...
/***/ function(module, exports, __webpack_require__) {
	...
	var _control = __webpack_require__(185);
	...
	var _reactGithubForkRibbon = __webpack_require__(193);
...
/***/ function(module, exports, __webpack_require__) {
	                ...
	                row.map(function (cell, j) {
	                  return _react2.default.createElement(_cell2.default, {
	                    ...
	                    handleClick: function handleClick() {
	                      return _this2.props.toggleAlive(i, j);
	                    }
	                  });
	                })
	              );
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return { toggleAlive: function toggleAlive(x, y) {
	      return dispatch((0, _actions.toggleAlive)(x, y));
	    } };
	};
...
/***/ function(module, exports) {
	...
	exports.toggleAlive = toggleAlive;
	  ...
	  _createClass(Control, [{
	    ...
	    value: function togglePlay() {
	      if (this.props.playState.isRunning) {
	        ...
	        var interval = setInterval(this.props.tick, 100);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    random: function random() {
	      return dispatch((0, _actions.makeRandomGrid)());
	    },
	    tick: function tick() {
	      return dispatch((0, _actions.tick)());
	    },
	    startPlaying: function startPlaying(timerId) {
	      return dispatch((0, _actions.startPlaying)(timerId));
	    },
	    stopPlaying: function stopPlaying() {
	      return dispatch((0, _actions.stopPlaying)());
	    },
	    clear: function clear() {
	      return dispatch((0, _actions.clear)());
	    }
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducer_board = __webpack_require__(189);

	var _reducer_board2 = _interopRequireDefault(_reducer_board);

	var _reducer_play_status = __webpack_require__(191);

	var _reducer_play_status2 = _interopRequireDefault(_reducer_play_status);

	var _reducer_generation_counter = __webpack_require__(192);

	var _reducer_generation_counter2 = _interopRequireDefault(_reducer_generation_counter);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var rootReducer = (0, _redux.combineReducers)({
	  board: _reducer_board2.default,
	  playState: _reducer_play_status2.default,
	  counter: _reducer_generation_counter2.default
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GRID_HEIGHT = 25;
	var GRID_WIDTH = 40;
	var initialGrid = grid.makeGrid(GRID_HEIGHT, GRID_WIDTH);

	exports.default = function () {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? initialGrid : arguments[0];
	  var action = arguments[1];
...
/***/ function(module, exports) {
	...
	var makeGrid = exports.makeGrid = function makeGrid(height, width) {
	  var makeRandom = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];
	...
	var advanceGrid = exports.advanceGrid = function advanceGrid() {
	  ...
	  var calculateNeighbours = function calculateNeighbours(x, y) {
	    ...
	    var topRow = x - 1 < 0 ? gridHeight - 1 : x - 1;
	    var bottomRow = x + 1 === gridHeight ? 0 : x + 1;
	    var leftColumn = y - 1 < 0 ? gridWidth - 1 : y - 1;
	    var rightColumn = y + 1 === gridWidth ? 0 : y + 1;
	  ...
	  for (var i = 0; i < gridHeight; i++) {
	    ...
	    for (var j = 0; j < gridWidth; j++) {
	      var cellIsAlive = grid[i][j].status;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactLibObjectAssign = __webpack_require__(40);

	var _reactLibObjectAssign2 = _interopRequireDefault(_reactLibObjectAssign);

	var _ribbonStyle = __webpack_require__(194);
...
/***/ function(module, exports) {
	...
	*/
	...
	exports.GitHubForkRibbon = GitHubForkRibbon;
